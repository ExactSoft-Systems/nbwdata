 ...
 */
class YouthApplicationWaiverAddStep6 extends ContentEntityForm {
...
/*
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['#prefix'] = '<i>Step 6 of 9</i>';
    return $actions;
  }
  ...
  public function goBack(array $form, FormStateInterface $form_state) {
    $entity = $this->getEntity();
    $id = $entity->id();
    $form_state->setRedirect('youth_application_waiver.step5', ['youth_application_waiver' => $id]);
  }
